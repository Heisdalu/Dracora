...
const Employees: FC<EmployeesProps> = ({
  ...
  return (
    <HomePageContainer>
      ...
      >
        <h1 className="text-[#0F172A] text-[1.875rem] font-[600]">Employees</h1>
        ...
        >
          <table className="text-center">
            <tbody className=" flex flex-col space-y-0.5 border-dggray border-[1px]">
              <tr className="place-items-cente grid pt-0.5 [grid-template-columns:1fr_1fr_1fr_1fr_1fr_1fr] [grid-gap:1rem]">
              ...
              {tableRowData.map((el, i) => (
                <tr
                  key={i}
                  className="py-1 border-t-[1px] border-dggray grid [grid-template-columns:1fr_1fr_1fr_1fr_1fr_1fr] [grid-gap:1rem] "
                >
                  <td>
                  ...
                  <td className="text-13px">{el.boss}</td>
